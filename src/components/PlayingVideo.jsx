...
//     fetchData(`/channel/channels/?id=${id}`).then((res) => {
//       console.log(res);
//       setVideo(res);
//     });
//   };
...
//             </div>
//             {/* Video playing code */}
//             {/* Channel name subcriptions and etc of video from vedio.jsx */}
...
function PlayingVideo() {
  ...
  return (
    <div className=" flex justify-center flex-row h-[calc(100%-56px)] mt-16">
      ...
      <div className="flex flex-col py-6 h-[calc(100vh-4.625rem)] overflow-y-scroll  overflow-x-hidden lg:w-[350px] xl:w-[400px]">
